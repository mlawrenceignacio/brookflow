      ...
      {isLoading ? (
        ...
        <>
          ...
          {isMenuOpen ? (
            ...
            <div className="flex-1 flex flex-col items-center  h-screen overflow-hidden p-3 2xl:p-5 gap-3 lg:gap-7 2xl:gap-8 overflow-y-auto scrollbar-hide flex-grow">
              ...
              <div className="flex flex-col items-center justify-center gap-4 2xl:gap-5 w-[100%] sm:w-[80%] 2xl:w-[80%] dark:bg-gray-900 bg-gray-200 py-5 2xl:py-8 rounded-lg shadow-lg">
                <div className="flex gap-5 justify-center w-[90%] sm:w-[80%] 2xl:w-[80%]">
                  <div className="dark:bg-gray-800 bg-green-400 px-9 sm:px-10 2xl:px-11 py-4 sm:py-7 lg:px-16 2xl:py-8 flex flex-col text-center items-center justify-center rounded-lg border border-black flex-1 sm:flex-none 2xl:flex-none">
                  ...
                  <img
                    ...
                    className="w-[120px] xl:w-[150px] 2xl:h-[150px] h-[120px] sm:flex-1 2xl:flex-none sm:h-full"
                  />
                ...
                <div className="flex gap-5 items-center w-[90%] sm:w-[80%]">
                ...
                <div className="flex-1 w-[90%] sm:w-[80%] 2xl:hidden">
                  <RandomFacts />
                </div>
              </div>
            </div>
